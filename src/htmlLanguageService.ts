...
export interface LanguageService {
    ...
    findDocumentHighlights(document: TextDocument, position: Position, htmlDocument: HTMLDocument): Array<DocumentHighlight>;
    doComplete(document: TextDocument, position: Position, htmlDocument: HTMLDocument, options?: CompletionConfiguration): CompletionList;
    doHover(document: TextDocument, position: Position, htmlDocument: HTMLDocument): Hover;
    format(document: TextDocument, range: Range, options: HTMLFormatConfiguration): Array<TextEdit>;
    findDocumentLinks(document: TextDocument, documentContext: DocumentContext): Array<DocumentLink>;
    findDocumentSymbols(document: TextDocument, htmlDocument: HTMLDocument): Array<SymbolInformation>;
}
