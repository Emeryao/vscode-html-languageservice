...
class MultiLineStream {
    ...
    public constructor(source: string, position: number) {
        this.source = source;
    ...
    public advanceIfChars(ch: Array<number>): boolean {
        let i: number;
    ...
    public advanceUntilChars(ch: Array<number>): boolean {
...
export function createScanner(input: string, initialOffset: number = 0, initialState: ScannerState = ScannerState.WithinContent): Scanner {
