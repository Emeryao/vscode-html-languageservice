...
export class Node {
    ...
    public get attributeNames(): Array<string> { return Object.keys(this.attributes); };
    public constructor(public start: number, public end: number, public children: Array<Node>, public parent: Node) {
    }
