...
export function findDocumentHighlights(document: TextDocument, position: Position, htmlDocument: HTMLDocument): Array<DocumentHighlight> {
...
function isBeforeOrEqual(pos1: Position, pos2: Position): boolean {
